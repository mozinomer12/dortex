...
class RangeInput {
    ...
    constructor(el) {
        ...
        //Call the plugin
        $(this.el.querySelector('.range-slider input[type=range]')).rangeslider({
...
// getting the value of output range

$(".output").on('DOMSubtreeModified', function () {
  var put_range_slider = ($(this).html());
  if (put_range_slider > 10) {
    $('.rnage-slider-error-masg').fadeOut();
    $(".main-image-container").css({'height' : '' + put_range_slider + 'mm'});
